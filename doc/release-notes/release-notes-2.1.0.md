ESA Core version *2.1.0* is now available!!
==============

  <https://github.com/ESAProject/ESAcoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/ESAProject/ESAcoin/commits/release_2.1.0>
