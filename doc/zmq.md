...
The ESA Core daemon can be configured to act as a trusted "border
router", implementing the esa wire protocol and relay, making
...
The ZeroMQ feature in ESA Core requires the ZeroMQ API >= 4.0.0
...
These options can also be provided in esa.conf.
