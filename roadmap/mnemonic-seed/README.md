...
A command-line option (-noseed) can be passed when starting esad and/or aipg-qt for the first time to create a wallet using the original key system that existed in Bitcoin and Aipg on Jan 3, 2019.
