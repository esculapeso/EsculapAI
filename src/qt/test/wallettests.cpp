...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<EsaAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_esa-qt -platform xcb      # Linux
//     src/qt/test/test_esa-qt -platform windows  # Windows
//     src/qt/test/test_esa-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = EsaUnits::formatWithUnit(unit, balance, false, EsaUnits::separatorAlways);
    ...
    // Amount input
    EsaAmountField* amountInput = receiveCoinsDialog.findChild<EsaAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: esa:")) != -1);
