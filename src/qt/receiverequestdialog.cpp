...
#include "config/esa-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatEsaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + EsaUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatEsaURI(info));
}
