...
{
    const char* pszTimestamp = "The DARQ Esculap technology serves as the foundation for constructing new DARQ Esculap generators";
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000355cd0ac1503c83052"); // New blockchain, no work done yet
	    ...
	    uint32_t nGenesisTime = 1685869871; // June 04, 2023, at 00:00:00 UTC	
...
public:
    CTestNetParams() {
        strNetworkID = "test";
        consensus.nSubsidyHalvingInterval = 2100000;  //~2 months
        consensus.nBIP34Enabled = true;
        consensus.nBIP65Enabled = true; // 
        consensus.nBIP66Enabled = true;
        consensus.nSegwitEnabled = true;
	    ...
	    uint32_t nGenesisTime = 1711710298; // June 04, 2023, at 00:00:00 UTC	
...
///*
        ...
        for (int i=0;i<40000000;i++) {
            ...
            if (UintToArith256(consensus.hashGenesisBlock) < BestBlockHashArith) {
                ...
                std::cout << "CHOOSE: genesis.GetHash().GetHex(): " << genesis.GetHash().GetHex() << " Nonce: " << i << " nGenesisTime: " << nGenesisTime << "\n";
        ...
        std::cout << "genesis.GetHash().GetHex() to 0x" << genesis.GetHash().GetHex() << std::endl;
...
//*/
        ...
        genesis = CreateGenesisBlock(nGenesisTime, 7268597, 0x1e00ffff, 2, 5000 *  COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
