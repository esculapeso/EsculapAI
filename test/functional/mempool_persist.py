...
By default, esad will dump mempool on shutdown and
...
class MempoolPersistTest(EsaTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give esad a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent esad from writing mempool.dat to disk. Verify that `savemempool` fails")
